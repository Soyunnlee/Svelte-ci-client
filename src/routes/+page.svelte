	...
	<div class="formWrap">
		<div class="formPosition" >
			<div class="w-full flex justify-center">
				<div class="block rounded-lg bg-white shadow-lg dark:bg-neutral-800" style="width:86%">
					<div class="g-0 lg:flex lg:flex-wrap flex items-center" style="width:100%">
						<div class="px-4 md:px-0 lg:w-[58%]" style="width:50%">
							<div class="lg:ml-24 lg:mr-12">
								<!-- margin-left: 6rem; margin-right: 3rem; -->
								
								<div class="text-center  my-12">
									<img
										class="mx-auto w-72 "
										src="https://i.esdrop.com/d/f/KRQCESGJO3/srkvKblZdg.png"
										alt="logo"
									/>
								</div>
								...
								<form on:submit={submitForm}>
									...
									<div class="relative mb-4" data-te-input-wrapper-init>
										<input
											type="password"
											class="border peer block min-h-[auto] w-full rounded bg-transparent py-[0.32rem] px-3 leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
									...
									<div class="mb-12 pt-1 pb-1 text-center">
										<a href="/dashboard">
											<button
												class="mb-3 inline-block w-full rounded px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal text-white 
												shadow-[0_4px_9px_-4px_rgba(0,0,0,0.2)] 
												transition duration-150 ease-in-out 
												hover:shadow-[0_8px_9px_-4px_rgba(0,0,0,0.1),0_4px_18px_0_rgba(0,0,0,0.2)] focus:outline-none focus:ring-0 active:shadow-[0_8px_9px_-4px_rgba(0,0,0,0.1),0_4px_18px_0_rgba(0,0,0,0.2)]
												"
												type="button"
												data-te-ripple-init
												data-te-ripple-color="light"
												style="
												background: linear-gradient(270deg, #66A6FF 0%, #667EEA 98.8%);
												"
											>
												Log in
											</button>
						...
						<div class="flex items-center rounded-b-lg lg:w-[42%] lg:rounded-r-lg lg:rounded-bl-none"
							style="width:50%"
						>
							<img src="https://i.esdrop.com/d/f/KRQCESGJO3/QVjchcUhU1.png" alt=""/>
						</div>
